$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Charlotte and Adam's Wedding",

            // Event start date
            start: new Date('July 05, 2022 13:00'),
            ...
            end: new Date('July 06, 2022 00:00'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $.post('https://script.google.com/macros/s/AKfycbxGUt-HzLMZiTEt0ScWwzoNMg5Jie-IP26S4HjryI6qW3dhxDn53osEAKbMxsg9cTnwmQ/exec', data)
                .done(function (data) {
                    console.log(data);
